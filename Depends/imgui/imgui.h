...
namespace ImGui
{
    ...
    IMGUI_API bool          ListBoxEx(const char* label, int* current_item, const char* const items[], int items_count, const ImVec2& size_arg, const ImVec4& cSelectColor = ImVec4(0, 0, 0, 0));
    IMGUI_API bool          ListBoxEx(const char* label, int* current_item, const char* (*getter)(void* user_data, int idx), void* user_data, int items_count, const ImVec2& size_arg, const ImVec4& cSelectColor = ImVec4(0, 0, 0, 0));
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColorEx(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawFlags flags);
...
namespace ImGui
{
    IMGUI_API void ToggleButton(const char* str_id, bool* v,
        ImColor border = { 0.7f, 0.7f, 0.7f, 1.0f },
        ImColor frame_btn = { 0.9f, 0.9f, 0.9f, 1.0f },
        ImColor off_color_hover = { 0.78f, 0.78f, 0.78f, 1.0f },
        ImColor on_color_hover = { 0.64f, 0.83f, 0.34f, 1.0f },
        ImColor off_color = { 0.85f, 0.85f, 0.85f, 1.0f },
        ImColor on_color = { 0.56f, 0.83f, 0.26f, 1.0f }) noexcept(true);
}
